...
REM
REM Generated by Vivado on Mon Aug 31 13:26:57 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj latch_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj latch_tb_vlog.prj -log xvlog.log
