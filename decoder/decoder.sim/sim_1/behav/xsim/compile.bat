...
REM
REM Generated by Vivado on Tue Sep 01 09:37:07 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj decoder_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj decoder_tb_vlog.prj -log xvlog.log
